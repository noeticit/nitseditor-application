    ...
    <div id="kt_header" class="kt-header  kt-header--fixed " data-ktheader-minimize="on">
        <div class="kt-container">
            ...
            <div class="kt-header__brand   kt-grid__item" id="kt_header_brand">
                <router-link to="/dashboard" class="kt-header__brand-logo" href="index.html">
                    <img alt="Logo" src="/nits-assets/media/logos/logo-4.png" class="kt-header__brand-logo-default" />
                    <img alt="Logo" src="/nits-assets/media/logos/logo-4-sm.png" class="kt-header__brand-logo-sticky" />
                </router-link>
            </div>
            ...
            <div class="kt-header__topbar kt-grid__item">
                ...
                <div class="kt-header__topbar-item kt-header__topbar-item--langs">
                    <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
										<span class="kt-header__topbar-icon">
											<img class="" src="/nits-assets/media/flags/020-flag.svg" alt="" />
										</span>
                    </div>
                ...
                <div class="kt-header__topbar-item kt-header__topbar-item--user">
                    <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
                        ...
                        <img alt="Pic" src="/nits-assets/media/users/300_21.jpg" class="kt-hidden" />
                    </div>
                    <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-xl">
